...
# Class Definition
class Car:
    # This is a specail function that gets called when a new car is created.
    ...
    # We're storing the "make" and "model" information in the car
        ...
        # Encapsulation hides the internal details of an objhe3ct and exposes only what is necessary
        # Think of it as specifiying the unique characteristics of each car.
        self.make = make
        self.model = model
...
# Think of creating cars without needing to understand the intricacies of car manufacturing.
...
# Creating the third car(object)
car3 = Car("Honda", "CRV")

# Creating the fourth car (object)
car4 = Car("Tesla", "Model3")
...
print(f"My wife owns a {car3.make} {car3.model}.")
print(f"I own an EV a {car4.make} {car4.model}.")
...
car3.start_engine() # Polymorphism: Car 3 starts its engine.
car4.start_engine() 
